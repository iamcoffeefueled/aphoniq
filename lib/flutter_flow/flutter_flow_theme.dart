...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF206870);
  late Color secondary = const Color(0xFF649DA6);
  late Color tertiary = const Color(0xFF649DA6);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF206870);
  late Color secondaryText = const Color(0xFF527B80);
  late Color primaryBackground = const Color(0xFFF0F5F9);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF206870);
  late Color accent2 = const Color(0xFF649DA6);
  late Color accent3 = const Color(0xFF1EA0AF);
  late Color accent4 = const Color(0xFFEEEEEE);
  late Color success = const Color(0xFF18D7F1);
